        ...
        <base-header class="pb-6">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <base-button size="sm" type="neutral" @click="newProduct">New Product</base-button>
                </div>
            </div>
        </base-header>
                ...
                <div class="col">
                    <div class="card">
                                ...
                                <template v-slot="{row}">
                                    <el-dropdown trigger="click" class="dropdown">
                                        ...
                                        <el-dropdown-menu class="dropdown-menu dropdown-menu-arrow show" slot="dropdown">
                                            <a class="dropdown-item" @click.prevent="() => $router.push('/products/edit/'+row.id)" href="#">Edit</a>
                        ...
                        <modal :show.sync="showConfirm">
                            ...
                            <div>
                                Are you sure to delete product with id "{{ selectedResource ? selectedResource.id : '' }}"?
                            </div>
    ...
    methods: {
        fetchList(pageQuery) {
            if (!this.initiated) {
                this.initiated  = true
                this.$store
                    .dispatch("products/fetchList", pageQuery)
                    .then(response => {
        ...
        remove(resource) {
            ...
            this.$store
                .dispatch('products/remove', resource.id)
                .then( () => {
