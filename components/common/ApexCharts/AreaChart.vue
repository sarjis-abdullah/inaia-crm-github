        ...
        <!-- <div class="toolbar">
            <ul class="nav nav-pills">
                <li class="nav-item mr-2 mr-md-0">
                    <a
                        href="#"
                        @click.prevent="updateData('one_month')"
                        id="one_month"
                        :class="{active: selection==='one_month', 'nav-link': true, 'py-2': true, 'px-3': true}"
                    >1M</a>
                </li>
                <li class="nav-item mr-2 mr-md-0">
                    <a
                        href="#"
                        @click.prevent="updateData('six_months')"
                        id="six_months"
                        :class="{active: selection==='six_months', 'nav-link': true, 'py-2': true, 'px-3': true}"
                    >6M</a>
                </li>
                <li class="nav-item mr-2 mr-md-0">
                    <a
                        href="#"
                        @click.prevent="updateData('one_year')"
                        id="one_year"
                        :class="{active: selection==='one_year', 'nav-link': true, 'py-2': true, 'px-3': true}"
                    >1Y</a>
                </li>
                <li class="nav-item mr-2 mr-md-0">
                    <a
                        href="#"
                        @click.prevent="updateData('ytd')"
                        id="ytd"
                        :class="{active: selection==='ytd', 'nav-link': true, 'py-2': true, 'px-3': true}"
                    >YTD</a>
                </li>
                <li class="nav-item mr-2 mr-md-0">
                    <a
                        href="#"
                        @click.prevent="updateData('all')"
                        id="all"
                        :class="{active: selection==='all', 'nav-link': true, 'py-2': true, 'px-3': true}"
                    >ALL</a>
                </li>
            </ul>
        </div> -->
        ...
        return {
            ...
            chartOptions: {
                ...
                //     }],
                    /*
                    xaxis: [{
                        x: new Date('24 Nov 2019').getTime(),
                        borderColor: '#0074d9',
                        yAxisIndex: 0,
                        label: {
                            show: true,
                ...
                xaxis: {
                    type: 'datetime',
                    // min: new Date('22 Oct 2019').getTime(),
    ...
    methods: {
        ...
        updateTimeLine: function () {
            ...
            switch (this.selection) {
                ...
                case 'six_months':
                    op = {
                        min: new Date(this.getOldDate(6)).getTime(),
                        max: new Date(this.getOldDate(0)).getTime(),
                    };
                    break;
                case 'one_year':
                    op = {
                        min: new Date(this.getOldDate(12)).getTime(),
                        max: new Date(this.getOldDate(0)).getTime(),
                    };
                    break;
                case 'ytd':
        ...
        getDateRange() {
            ...
            switch (this.selection) {
                case 'one_month':
                    ...
                    break;
                case 'six_months':
                    queryStr    = 'start='+this.getOldDate(6)+'&end='+this.getOldDate(0);
                    break;
                case 'one_year':
                    queryStr    = 'start='+this.getOldDate(12)+'&end='+this.getOldDate(0);
                    break;
                case 'ytd':
                    this.chartOptions = {
                        xaxis: {
        ...
        getOldDate(months) {
            let d = new Date();
            d.setMonth(d.getUTCMonth() - months);
