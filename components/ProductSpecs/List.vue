        ...
        <base-header class="pb-6">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <base-button size="sm" type="neutral" @click="newProductSpec">New Product Spec</base-button>
                </div>
            </div>
        </base-header>
                ...
                <div class="col">
                    <div class="card">
                        <div class="border-0 card-header">
                            <div class="row">
                                <div class="col">
                                    <h3 class="mb-0">Product Specs List</h3>
                                </div>
                                <!-- <div class="col">
                        ...
                        <el-table class="table-responsive table-flush"
                            ...
                            <el-table-column label="Name"
                                            ...
                                            prop="name">
                                <template v-slot="{row}">
                                    <span class="status">{{ row.name || 'N/A' }}</span>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column label="Value"
                                            ...
                                            prop="value">
                                <template v-slot="{row}">
                                    <span class="status">{{ row.value || 'N/A' }}</span>
                                </template>
                            </el-table-column>

                            <el-table-column label="Product Class Name"
                                            min-width="240px"
                                            prop="name_translation_key">
                                <template v-slot="{row}">
                                    <span class="status">{{ row.productClass.name_translation_key || 'N/A' }}</span>
                                </template>
                            </el-table-column>
                                ...
                                <template v-slot="{row}">
                                    <el-dropdown trigger="click" class="dropdown">
                                        ...
                                        <el-dropdown-menu class="dropdown-menu dropdown-menu-arrow show" slot="dropdown">
                                            <a class="dropdown-item" @click.prevent="() => $router.push('/product-specs/edit/'+row.id)" href="#">Edit</a>
                        ...
                        <modal :show.sync="showConfirm">
                            ...
                            <div>
                                Are you sure to delete product class spec with id "{{ selectedResource ? selectedResource.id : '' }}"?
                            </div>
    ...
    methods: {
        fetchList(pageQuery) {
            if (!this.initiated) {
                this.initiated  = true
                this.$store
                    .dispatch("product-specs/fetchList", pageQuery)
                    .then(response => {
        ...
        newProductSpec() {
            this.$router.push('/product-specs/add')
        },
        ...
        remove(resource) {
            ...
            this.$store
                .dispatch('product-specs/remove', resource.id)
                .then( () => {
