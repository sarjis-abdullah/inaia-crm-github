                ...
                <div class="col">
                    <div class="card">
                        ...
                        >
                            ...
                            >
                                <template v-slot="{row}">
                                    <span class="status">{{ row.title }}</span>
                                </template>
                            </el-table-column>
                        ...
                        <modal :show.sync="showPopup">
                            <template slot="header">
                                <h5 class="modal-title" id="exampleModalLabel">Feed details</h5>
                            </template>
                            <div>
    ...
    methods: {
        ...
        fetchList(pageQuery) {
            if (!this.initiated) {
                this.initiated  = true
                this.$store
                    .dispatch("news-feeds/fetchList", pageQuery)
                    .then(response => {
        ...
        newFeed() {
            this.$router.push('/news-feeds/add')
        },
