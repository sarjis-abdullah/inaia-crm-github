export default {
    ...
    loading_ticket_details:"Daten werden geladen",
    ...
    order_status_payment_outstanding:'Zahlung offen',
    depot_status_completed:'Vertragsende',
    ...
    complete_contract:'Sparplan beenden (Vertragsende)',
    ...
    from_created_date:'Erstellungsdatum (von)',
    to_created_date:'Erstellungsdatum (bis)',
    ...
    password_is_required: "Bitte geben Sie ein neues Passwort an",
    confirm_password: "Neues Passwort bestätigen",
    confirm_password_is_required: "Bitte bestätigen Sie Ihr neues Passwort",
    password_reset_with_success: "Das Passwort wurde erfolgreich zurückgesetzt",
    clickHere: "Hier klicken",
    requestNewLink: "Der Link ist abgelaufen, bitte fordern Sie einen neuen Link an:",
    confirm: "Bestätigen",
    confirm_password_mismatch: "Das Bestätigungspasswort stimmt nicht überein",
    password_message: "Ihr Passwort muss mindestens 8 Zeichen lang sein und Sonderzeichen enthalten",
