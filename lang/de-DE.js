export default {
    ...
    order_status_payment_outstanding:'Zahlung offen',
    ...
    paid: 'Bezahlt',
    mark_many_as_paid:'Mehrere als bezahlt markieren',
    pending_amount:'Betrag offen',
    aggregated_claims:'Aggregated claims',
    paid_amount:'Bezahlt gesamt',
    gold_delivery_charge:'Versandkosten',
    ...
    account_notes:'Notizen',
    cant_create_new_note:"We can't create new note due to an error",
    load_more:'Load more',
    depot_comment:'Notizen',
    at_least_four_caracters:'Suche erfordert min. 4 Zeichen',
    ...
    assets:'Assets',
    depot_type:'Depot-Typ',
    Gold:'Gold',
    Silver:'Silber',
    confirm_contract:'Vertrag bestätigen',
    do_you_want_to_confirm_contract:'Sparplan bestätigen?',
    savingplan_activated_successfully:'Sparplan wurde aktiviert',
    savinplan_activated_unsuccessfully:"Sparplan konnte nicht aktiviert werden",
    silver_sell:'Verkauf',
    silver_purchase:'Kauf',
    silver_delivery:'Auslieferung',
    silver_transfer_in:'Transfer Eingang',
    silver_transfer_out:'Transfer Ausgang',
    silver_gift:'Gutschrift',
    silver_price_per_gram:'Silberpreis / g',
    order_status_payment_inprogress:'Zahlung angewiesen',
    stocks:'Bestand',
    inaia_stock:'INAIA Stock',
    operation_stock:'Operations Stock',
    ...
    select_supplier:'Lieferanten wählen',
    edit_supplier:'Lieferant auswählen',
    ...
    stock_transactions:' Transaktionen',
    search_by_reference:'Search by reference',
    transaction_type:'Typ',
    CREDIT:'CREDIT',
    DEBIT:'DEBIT',
    fixing:'Fixing',
    no_document:'Keine Dokumente',
    no_supplier:'Kein Lieferant',
    document:'Dokument',
    supplier:'Lieferant',
    balance_before:'Bestand vorher',
    balance_after:'Bestand nachher',
    ...
    inaia_banking_account:'Bankkonto',
    payment_failed:'Zahlung fehlgeschlagen',
    no_claim_data_available:'No data available for the year',
    sales_commission:'Provisionsabrechnung',
    sales_advisors:'Berater',
    reason:'Verwendungszweck',
    target_amount:'Vertragssumme',
    direction:'direction',
    ...
    file_is_too_big:'Datei ist zu groß',
    title_must_be_at_least_five:'Mindestlänge beträgt 5 Zeichen',
    verify:'Verifizieren',
    client_verified_successfully:'Kunde wurde verifiziert',
    client_verified_unsuccessfully:"Fehler: Kunde konnte nicht verifiziert werden",
    allow_marketing:'Marketing allowed',
    en:'Englisch',
    de:'Deutsch',
    fr:'Französisch',
    allowed:'Berechtigt',
    not_allowed:'Nicht berechtigt',
    add:'Hinzufügen',
    news_feed:'Newsfeed',
    start_at:"Beginn",
    end_at:"Ende",
    ...
    drop_thumbnail_here:'Bild hier ablegen oder',
    are_you_sure_you_want_to_desactivate_account:'Account wirklich deaktivieren?',
    account_desactivated_successfully:'Account wurde deaktiviert',
    account_desactivated_unsuccessfully:"Fehler: Account konnte nicht deaktiviert werden",
    account_activated_successfully:'Account wurde aktiviert',
    account_activated_unsuccessfully:"Fehler: Account konnte nicht aktiviert werden",
    are_you_sure_you_want_to_activate_account:'Account wirklich aktivieren?',
    are_you_sure_you_want_to_unlock_account:'Account wirklich entsperren?',
    account_unlock_successfully:'Account wurde entsperrt',
    account_unlock_unsuccessfully:"Fehler: Account konnte nicht entsperrt werden",
    payment_method:'Zahlungsmethode',
    depot_status_blocked:'Gesperrt',
    mobile:'Mobilnr.',
    confirm:'Bestätigen',
    edit_salesadvisor:'Berater zuweisen',
    sales_advisor:'Kundenberater',
    ...
    order_reverted:'Verwertung Rücklauf',
    ...
    gold_storage_fee:'Lagerkosten Gold',
    gold_storage_fee_yearly:'Lagerkosten Gold (jährl.)',
    silver_storage_fee:'Lagerkosten Silber',
    silver_storage_fee_yearly:'Lagerkosten Silber (jährl.)',
    direct_debit_return:'Rücklastschrift',
    silver_withdrawal:'Silver withdrawal',
    paused_until:'Pausiert bis',
    select_end_pause_date_placeholder:'End pausing date',
    interval_day:'Zahlungsinterval',
    '15':'15.',
    '1':'1.',
    referred_by:'Empfehlung von',
    no_referrer:'-',
    block_depot:'Depot sperren',
    activate_depot:'Depot aktivieren',
    are_you_sure_you_want_to_block_depot:'Depot wirklich sperren?',
    Depot_blocked_successfully:'Depot wurde gesperrt.',
    Depot_blocked_unsuccessfully:"Fehler: Depot konnte nicht gesperrt werden",
    edit_saving_plan:'Vertragsdaten anpassen',
    billing_method:'Zahlungsmethode',
    success_updating_saving_plan:'Vertragsdaten wurden geändert',
    error_updating_saving_plan:"Fehler: Vertragsdaten konnten nicht geändert werden",
    confirm_failed_order:'Als fehlgeschlagen markieren?',
    ...
    order_status_payment_outstanding:'Zahlung offen',
    depot_status_completed:'Ausgeführt',
    discount_pay_immediately:'Rabatt Agio-Sofort',
    discount_inaia_special_offer:'Aktions-Rabatt',
    discount_from_advisor:'Berater-Rabatt',
    skip_transaction_fee:'Keine Transaktionskosten für diesen Auftrag',
    ...
    deposit:'Gramm-Einlage',
    add_deposit:'Gramm-Einlage',
    deposit_created_successfully:'Eintrag erfolgreich erstellt',
    deposit_created_unsuccessfully:"Fehler: Eintrag konnte nicht erstellt werden",
    billing:'Verrechnung',
    fixing_price:'Fixing',
    ...
    default:'Default',
    validated:'Verifiziert',
    not_validated:'Nicht verifiziert',
    do_you_want_to_delete_bank_account:'Bankverbindung wirklich löschen?',
    ...
    entry_added_failed:"Error: We couldn't add the this entry due to an error",
    manage_payments:'Zahlungsmethoden bearbeiten',
    ...
    initiate_payment:'Lastschrifteinzug starten',
    invested_amount:'Betrag investiert',
    of:'von',
    added_amount:'Abschlusskosten (Agio) anpassen',
    added_amount_explanation:'Die Abschlusskoten werden um den hier eingetragenen Wert erhöht. Beim Speichern wird eine neue Agio-Transaktion vom Typ `Forderung` erstellt',
    monthly_payment:'Monatliche Zahlung',
    change_target_amount:'Vertragssumme ändern',
    purchase_amount:'Kaufbetrag',
    add_claim:'Forderung erstellen',
    claim_type:'Typ',
    ...
    depot_history:'Depot-Historie',
    create_claim:'Forderung erstellen',
    claim_status:'Status',
    initiate_payment_for_all:'Initiate payment for all claims',
    ref:'ref',
    choose_execute_date:'Ausführungsdatum wählen',
    select_execution_date:'Ausführungsdatum wählen',
    ...
    payment_in_progress:'Zahlung angewiesen',
    transaction_fee:'Transactionskosten',
    ...
    change_transaction_fee:'Transaktionskosten ändern',
    created_by:'Erstellt von',
    updated_by:'Geändert von',
    order:'Auftrag',
    file_Uploaded_successfully:'Document uploaded successfully',
    monthly_performance:'Performance report',
    client_document:'Dokumentenverzeichnis',
    upload_document:'Dokumente hochladen',
    verify_client:'Verifizierung bestätigen',
    decline_client:'Verifizierung ablehnen',
    reports:'Reports',
    monthly:'Monatlich',
    firstname:'Vorname',
    middlename:"Middlename",
    lastname:'Nachname',
    pending_verifications:'Identitätsprüfung',
    change_payment_method:'Zahlungsweise ändern',
    ...
    batch_claims:'Forderungen (Stapelverarbeitung)',
    batch_orders:'Aufträge (Stapelverarbeitung)',
    create_batch:'Stapel erstellen',
    total_claim_count:'Forderungen gesamt',
    ...
    withdraw_contract:'Sparplan widerrufen',
    ...
    complete_contract:'Sparplan beendenn (Vertragsende)',
    ...
    activate_contract:'Sparplan aktivieren',
    ...
    remove_claims:'Forderungen löschen',
    debit_date:'Datum Lastschrifteinzug',
    notify_user:'Pre-Notification senden',
