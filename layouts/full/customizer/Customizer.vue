...
<script>
	...
	computed: {
        ...
        theme: {
            get() {
                return this.$store.state.vuesax.theme;
            },
            set(val) {
                this.$store.commit('vuesax/SET_THEME', val);
            }
        },
        themeColor: {
            get() { return this.$store.state.vuesax.themeColor },
            set(val) { this.$store.commit('vuesax/SET_THEME_COLOR', val) }
        },
	},
	methods: {
